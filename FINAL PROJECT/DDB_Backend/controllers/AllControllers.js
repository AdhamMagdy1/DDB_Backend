...
const productController = {
  createProduct: async (req, res, next) => {
    try {
      ...
      insert into [${aswanSERVER}].InventoryAswan.dbo.product (Product_ID,Product_Name,"Description",Unit_Price,Manufacturer ) values(@ProductId,'${Product_Name}','${Description}','${Unit_Price}', '${Manufacturer}');
      commit;`,
        {
  ...
  deleteProductById: async (req, res, next) => {
    try {
      ...
      delete from [${aswanSERVER}].InventoryAswan.dbo.product where Product_ID =${req.params.id} ; 
      commit;`);
  ...
  updateProductByById: async (req, res, next) => {
    try {
      ...
      UPDATE product
      SET product_name='${Product_Name}',"Description"='${Description}' , unit_price=${Unit_Price},manufacturer='${Manufacturer}'
      WHERE product_id= ${req.params.id};
      
      UPDATE [${cairoSERVER}].InventoryCairo.dbo.product
      SET product_name='${Product_Name}',"Description"='${Description}' , unit_price=${Unit_Price},manufacturer='${Manufacturer}'
      WHERE product_id= ${req.params.id};
      
      UPDATE [${aswanSERVER}].InventoryAswan.dbo.product
      SET product_name='${Product_Name}',"Description"='${Description}' , unit_price=${Unit_Price},manufacturer='${Manufacturer}'
      WHERE product_id= ${req.params.id};
...
const supplierController = {
  createSupplier: async (req, res, next) => {
    try {
      const supplier = await sequelize.query(
        ...
        insert into [${aswanSERVER}].InventoryAswan.dbo.Supplier (Supplier_ID,Supplier_Name,Phone,Email) values(@Supplier_ID,'${req.body.Supplier_Name}','${req.body.Phone}', '${req.body.Email}');
        commit;`,
        {
          type: QueryTypes.SELECT,
          model: Supplier,
  ...
  deleteSupplierById: async (req, res, next) => {
    try {
      ...
      delete from [${aswanSERVER}].InventoryAswan.dbo.Supplier where Supplier_ID = ${req.params.id};
      commit;`)
...
const inventoryController = {
  createInventory: async (req, res, next) => {
    try {
      ...
      insert into Inventory values(${req.body.Capacity},${req.body.Location_ID});
  ...
  deleteInventoryById: async (req, res, next) => {
    ...
    delete from Inventory where Inventory_ID = ${req.params.id} ;
      ...
      delete from [${aswanSERVER}].InventoryAswan.dbo.Inventory where Inventory_ID = ${req.params.id} ;
      commit;`,
        {
          type: QueryTypes.INSERT,
          model: Product,
